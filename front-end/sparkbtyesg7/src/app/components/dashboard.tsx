...
import CreateEventForm from './eventform'; // Component for creating new events.
import EventList from './eventlist'; // Component for displaying a list of events.
import Navbar from './navbar'; // Component for rendering the navigation bar.
